...
function displayResult(player, status) {
    ...
    if (status == "won") {
        ...
        if (player == 'X') {
            if(typeOfgame==1)
            document.getElementById("result").innerText = "Memenangkan Permainan!";
            else{
            ...
            if(typeOfgame==1)
            document.getElementById("result").innerText = "Kalah Permainan!";
            else{
        ...
        document.getElementById("result").innerText = "Permainan Seri!";
    }
}
